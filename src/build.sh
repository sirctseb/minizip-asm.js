...
emcc -s USE_ZLIB=1 -O -I../.. -DHAVE_AES -o ../../../lib/minizip.js main.cpp --memory-init-file 0 -s ALLOW_MEMORY_GROWTH=1 -s NO_FILESYSTEM=0 -s EXPORTED_FUNCTIONS="['_list', '_extract', '_append']" --pre-js main_pre.js --post-js main_post.js zip.o unzip.o ioapi.o ioapi_mem.o libaes.o -Oz
